...
namespace Menu {
    ...
    void Render() {
        ...
        // Global hotkeys — always active regardless of tab
        GameModsTAB::Tick();
        ...
        if (ImGui::Begin("Il2CppInspectorPro by Jadis0x", &settings.bShowMenu, ImGuiWindowFlags_NoCollapse))
        {
            ...
            ImGui::BeginChild("Sidebar", ImVec2(0, 0), false);
            {
                ...
                if (SidebarButton("Game Mods", currentTab == 2, ImVec2(-1, 35))) currentTab = 2;
                if (SidebarButton("WEB Api", currentTab == 3, ImVec2(-1, 35))) currentTab = 3;
            ...
            ImGui::BeginChild("Content", ImVec2(0, 0), true);
            {
                ...
                case 2: GameModsTAB::Render(); break;
                case 3: WebApiTAB::Render(); break;
                }
            }
            ImGui::EndChild();
            ImGui::PopStyleVar();
